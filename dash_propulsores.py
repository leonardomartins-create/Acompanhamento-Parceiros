...
# --- PASSO 2: NOMES DAS COLUNAS (CORRIGIDOS COM BASE NA SUA FOTO) ---
# Tentei manter o que funcionava no seu código original
col_empresa = "Tipo de Empresa"     # Parece que seus dados de "Física/MEI" estão aqui
...
# --- NOVO FILTRO: PARCEIRO (JUMIO/CAF) ---
...
# --- PASSO 5: LAYOUT ORIGINAL (TABELAS EM CIMA, GRÁFICOS EMBAIXO) ---
...
# Layout de Tabelas Lado a Lado (Igual a primeira imagem)
...
# Gráficos de Pizza e Barras (Lado a Lado embaixo)
g1, g2 = st.columns(2)
...
with st.expander("📂 Abrir Base de Dados Detalhada"):
    ...
    try:
        ...
        st.dataframe(tabela_filtrada, use_container_width=True)import streamlit as st
import pandas as pd
import plotly.express as px
import hmac
